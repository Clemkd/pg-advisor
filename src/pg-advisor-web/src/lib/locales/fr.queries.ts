...
export const frQueries: Record<string, string> = {
  ...
  'queries.modal.showSql': 'Voir le SQL',
  'queries.modal.hideSql': 'Masquer le SQL',
  ...
  'queries.params.showEditor': 'Changer les valeurs',
  'queries.params.hideEditor': 'Replier les valeurs',
  ...
  'plan.total.execution': 'Exécution',
  'plan.total.planning': 'Planification',
  'plan.total.cost': 'Coût total',
  'plan.total.nodes': 'Nœuds',

  'plan.highlight': 'Mettre en évidence',
  'plan.metric.self': 'Temps propre',
  'plan.metric.inclusive': 'Temps cumulé',
  'plan.metric.cost': 'Coût propre',
  'plan.metric.rows': 'Lignes',
  ...
  'plan.node.selfTitle': 'Temps propre, hors sous-arbre',
  'plan.node.rowsTitle': 'Lignes remontées, boucles comprises',
  ...
  'plan.node.costTitle': 'Coût propre au nœud, enfants déduits — coût cumulé {total}',
  ...
  'plan.field.selfMs': 'Temps propre',
  'plan.field.inclusiveMs': 'Temps cumulé',
  'plan.field.actualRows': 'Lignes réelles',
  'plan.field.planRows': 'Lignes estimées',
  'plan.field.estimation': 'Écart d’estimation',
  'plan.field.loops': 'Boucles',
  'plan.field.startupCost': 'Coût de démarrage',
  'plan.field.totalCost': 'Coût cumulé',
  'plan.field.width': 'Largeur',
  'plan.field.sharedHit': 'Blocs en cache',
  'plan.field.sharedRead': 'Blocs lus sur disque',
  'plan.field.sharedDirtied': 'Blocs salis',
  'plan.field.sharedWritten': 'Blocs écrits',
  'plan.field.tempRead': 'Blocs temporaires lus',
  'plan.field.tempWritten': 'Blocs temporaires écrits',
  'plan.field.heapFetches': 'Accès au heap',
  'plan.field.sortMethod': 'Méthode de tri',
  'plan.field.sortSpace': 'Espace de tri',
  'plan.field.rowsRemoved': 'Lignes écartées par le filtre',
  'plan.field.indexCondition': 'Condition d’index',
  'plan.field.filter': 'Filtre',
  'plan.field.recheck': 'Revérification',
  'plan.field.hashCondition': 'Condition de hachage',
  'plan.field.joinFilter': 'Filtre de jointure',
  'plan.field.sortKey': 'Clé de tri',
  'plan.field.groupKey': 'Clé de regroupement',
  'plan.field.parallelAware': 'Parcours parallèle',
  'plan.field.workersPlanned': 'Processus prévus',
  'plan.field.workersLaunched': 'Processus lancés',
  'plan.field.nodeType': 'Type de nœud',
  'plan.field.subplan': 'Sous-plan',
  'plan.field.relation': 'Relation',
  'plan.field.alias': 'Alias',
  'plan.field.index': 'Index',
  'plan.field.joinType': 'Type de jointure',
  'plan.field.scanDirection': 'Sens de parcours',
  'plan.field.parentRelationship': 'Rôle chez le parent',
  ...
  'plan.table.column.cost': 'Coût',
  'plan.table.column.self': 'Temps propre',
  'plan.table.column.inclusive': 'Cumulé',
  'plan.table.column.rows': 'Lignes',
  'plan.table.column.estimation': 'Estimation',
  'plan.table.column.reads': 'Blocs lus',
  'plan.table.sort.reads': 'Blocs lus sur disque',
